...
const writeGameToDB = (props) => {
  ...
  const dataDB = {
    ...
    gameUpperRangeLimit: props.gameUpperRangeLimit,
...
const emailResultToParent = (props) => {
  ...
  const resultSummaryStr = `${props.playerName}: ${resultDate} Upperlimit:${props.gameUpperRangeLimit}(${gameType}) ${props.gameQuestionTime}s/Q ${props.percentageCorrect}%`;
  ...
  Meteor.call(
    ...
    props.parentEmail,
    'practice_results@mathcombat.co.za',
    resultSummaryStr,
    gameAnswersStr,
  );
};
